...
if __name__ == '__main__':
    ...
    # Multi-query
    if ag.multi:
        multi_query_feature = extract_feature(model, data_itr['multi-query'])

    # Save the features to .mat file
    # result = {'gallery_f': gallery_feature.numpy(), 'gallery_label': gallery_label, 'gallery_cam': gallery_cam,
              # 'query_f': query_feature.numpy(), 'query_label': query_label, 'query_cam': query_cam}
    # scipy.io.savemat('features_60.mat', result)

    # Multi-query
    if ag.multi:
        result = {'mquery_f': multi_query_feature.numpy(), 'mquery_label': mquery_label, 'mquery_cam': mquery_cam}
        scipy.io.savemat('multi_query_features_erasing.mat', result)
