...
if __name__ == '__main__':
    ...
    # Training function
    def train_process(model, criterion, optimizer, scheduler, num_epochs=50):
    ...
    def save_network(model, epoch):
        ...
        save_path = os.path.join('./DukeMTMC', model_name, save_filename)
    ...
    def draw_curve(current_epoch):
        ...
        if current_epoch == 0:
            ax0.legend()
            ax1.legend()
        fig.savefig(os.path.join('./DukeMTMC', model_name, 'train_result.jpg'))
    ...
    dir_name = os.path.join('./DukeMTMC', model_name)
